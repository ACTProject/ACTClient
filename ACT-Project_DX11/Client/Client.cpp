...
void Client::Init()
{
	...
	// Camera
	{
        ...
        // Start CutScene
        CUTSCENE->AddEvent(CutsceneEvent({ 105.951f, 76.7523f, 63.4459f }, { 318.6f, 76.7523f, 46.3121f }, { 0.0567932f, -0.707107f, 0.704822f }, 15.0f));
    ...
    // Shell
    {
        ...
        shell->GetOrAddTransform()->SetPosition(Vec3(186.5f,-4.0f,24.7f));
